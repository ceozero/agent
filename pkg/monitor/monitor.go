...
func GetState(skipConnectionCount bool, skipProcsCount bool) *model.HostState {
	...
	printf("Host State - NetInTransfer: %d, NetOutTransfer: %d, NetInSpeed: %d, NetOutSpeed: %d, Uptime: %d", ret.NetInTransfer, ret.NetOutTransfer, ret.NetInSpeed, ret.NetOutSpeed, ret.Uptime)
...
func TrackNetworkSpeed() {
	...
	printf("Network Stats - InTransfer: %d, OutTransfer: %d, InSpeed: %d, OutSpeed: %d, LastUpdate: %d", innerNetInTransfer, innerNetOutTransfer, netInSpeed, netOutSpeed, lastUpdateNetStats)
